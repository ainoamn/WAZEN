...
const ERRORS: Record<string, Pair> = {
  ...
  MEMBER_PHONE_TAKEN: ["هذا الرقم مسجّل لمستخدم موجود. لا يُسمح بتكرار رقم الهاتف داخل الجمعية", "This phone number already belongs to an existing member. Phone numbers cannot be repeated in this association"],
};
