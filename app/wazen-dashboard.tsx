      ...
      <form className="modal-form" onSubmit={submit}>
        ...
        <label>
          ...
          <div className="money-input">
            ...
            <b className="money-currency"><OmrSymbol className="h-3.5 w-auto" /></b>
          </div>
        </label>
        <label>
