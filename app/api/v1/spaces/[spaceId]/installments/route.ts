...
import { listV1Installments } from "../../../../../../lib/v1-installments";
...
export async function GET(
  ...
  return withRequestTiming("v1.installments.get", async () => {
    try {
      ...
      return await runWithDbUser(user.id, async () => {
        ...
        const installments = await listV1Installments(db, space, { memberId, limit });
