  ...
  return <main className="commerce-landing">
    ...
    <section className="commerce-hero">
      <div className="commerce-hero-copy">
        ...
        <div className="commerce-hero-actions"><Link href="/login?local=1&next=%2Fhome">{l("ابدأ مجاناً", "Start free")}<Arrow size={18} /></Link><Link className="secondary" href="/pricing">{l("استعرض الباقات", "View pricing")}</Link></div>
