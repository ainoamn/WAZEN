...
| تصفية/تصفير لا تظهر إلا للشخصية | زر التصفير كان مشروطًا بـ `space.type === "personal"` | أزرار **تصفية وتصفير** و**حذف المحفظة** داخل نافذة «ضبط المحفظة» لكل الأنواع؛ الشريط الخارجي يحتفظ بالأرشفة فقط |
