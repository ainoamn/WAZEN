...
- Cron: `/api/jobs/tick` once a day at 02:00, 03:00, 06:00, and 14:00 UTC (`vercel.json`, Hobby limit) — email/push/webhooks each run; privacy at 03:00 UTC; dues digest and personal bill reminders at 06:00 UTC; maintenance at 02:00 UTC  
