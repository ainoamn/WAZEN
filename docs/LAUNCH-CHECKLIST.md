...
- Cron: `/api/jobs/tick` every 5 minutes (`vercel.json`) — email/push; dues at 06:00 UTC; maintenance at 02:00 UTC  

Handoff: [HANDOFF-2026-08-24-phase9.md](./HANDOFF-2026-08-24-phase9.md)
