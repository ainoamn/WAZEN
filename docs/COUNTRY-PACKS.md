...
Current foundations: Saudi Arabia (SAR, 15%), United Arab Emirates (AED, 5%) and Oman (OMR, 5%). These are technical defaults, not tax advice. Before activating a country commercially, validate tax rules, invoice wording/numbering, data residency, consumer law, supported payment methods, address/phone formats and Arabic/English legal copy with local specialists.
