...
**للمتابعة من جهاز آخر ابدأ من:** **[docs/HANDOFF-2026-08-14.md](./docs/HANDOFF-2026-08-14.md)** (الحالة الحالية، الملفات، الفترات المحاسبية، الأعضاء، أوامر التشغيل).

## التوثيق الكامل

| الملف | المحتوى |
|--------|---------|
| **[docs/HANDOFF-2026-08-14.md](./docs/HANDOFF-2026-08-14.md)** | **متابعة العمل الآن** — استنساخ، قواعد المبالغ، الفترات، الأعضاء، مصروف الصندوق، خريطة الملفات |
...
راجع `docs/NEON-SETUP.md` و`docs/PRODUCTION-DEPLOYMENT.md` قبل النشر على Vercel. التسليم الحالي للمتابعة: `docs/HANDOFF-2026-08-14.md`.
