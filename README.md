...
**للمتابعة من جهاز آخر ابدأ من:** **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** (القائمة الجانبية وشارة الترقية، ترقيم العمليات، أوامر التشغيل).

## التوثيق الكامل

| الملف | المحتوى |
|--------|---------|
| **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** | **متابعة العمل الآن** — شارة ترقية للقائمة، ترقيم العمليات، تصفية المحفظة |
