...
**للمتابعة من جهاز آخر ابدأ من:** **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** (شارة الترقية، حدود الاشتراك، جدول مقارنة الباقات).

## التوثيق الكامل

| الملف | المحتوى |
|--------|---------|
| **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** | **متابعة العمل الآن** — شارة ترقية، حدود الاشتراك، جدول مقارنة الباقات |
