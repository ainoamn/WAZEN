...
**للمتابعة من جهاز آخر ابدأ من:** **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** (شارة الترقية، حدود الاشتراك، استوديو الباقات).

## التوثيق الكامل

| الملف | المحتوى |
|--------|---------|
| **[docs/HANDOFF-2026-08-17.md](./docs/HANDOFF-2026-08-17.md)** | **متابعة العمل الآن** — شارة ترقية، حدود الاشتراك، استوديو `/admin/plans` |
